...
Private Sub TimerMovimento_Timer()
    ...
    Select Case TeclaPressionada
        ...
        Case 37 'Or 39 'Seta para o lado esquerdo
            'Move o Bloco uma posição para a esquerda
            
            ' Verifica qual o tipo de Bloco em movimento no momento e
            'define os blocos a serem verificados
                ...
                Case 0
                    ...
                    Select Case PosicaoDoBloco
                        ...
                        Case 0
                            ...
                            'conjunto de blocos
                            Blocos_a_Analisar(0) = 1
                            Blocos_a_Analisar(1) = 999
                            Blocos_a_Analisar(2) = 999
                            Blocos_a_Analisar(3) = 999
                        
                        Case 1
                            ' Verifica apenas a posição diretamente
                            'abaixo do bloco "4" do conjunto
                            Blocos_a_Analisar(0) = 1
                            Blocos_a_Analisar(1) = 2
                            Blocos_a_Analisar(2) = 3
                            Blocos_a_Analisar(3) = 4
                ...
                Case 2
                    ...
                    Select Case PosicaoDoBloco
                        ...
                        Case 3
                            ...
                            Blocos_a_Analisar(0) = 2
                            Blocos_a_Analisar(1) = 3
                            Blocos_a_Analisar(2) = 4
                            Blocos_a_Analisar(3) = 999
...
MoverEsquerdaDireita:
    ...
    ' Verifica as posições solicitadas dos blocos e os move para
    'esquerda ("TeclaPressionada = 37") ou direita ("TeclaPressionada = 39")
    ' Obs.: A informação "999" armazenada em "Blocos_a_Analisar"
    'indica que aquela posição não deve ser verificada
    ContadorMovimento = 0
    
    Do While ContadorMovimento <= 3
    
        If Blocos_a_Verificar(ContadorMovimento) <> 999 Then
    
            Posicao_na_Matriz = LocalizarBlocoNaMatriz(IndicesEmJogo(Blocos_a_Analisar(ContadorMovimento)))
        
            ' Verifica se a posição logo abaixo deste bloco
            'contém outro bloco ou será a linha 18 da matriz
            
            'Verifica se é a a coluna 1
            ...
            Else
                'Verifica se pode haver colisão
                If Jogo(Posicao_na_Matriz.PosicaoY + 1, Posicao_na_Matriz.PosicaoX) <> 999 Then
                    'Indica colisão
        ...
        ContadorMovimento = ContadorMovimento + 1
...
'Realiza o movimento de descida dos Blocos
        ...
        Case 0
            ...
            Select Case PosicaoDoBloco
                ...
                Case 0
                    ' Verifica todas as posições abaixo do
                    'conjunto de blocos
                    Blocos_a_Verificar(0) = 1
                    Blocos_a_Verificar(1) = 2
                    Blocos_a_Verificar(2) = 3
                    Blocos_a_Verificar(3) = 4
                
                Case 1
                    ' Verifica apenas a posição diretamente
                    'abaixo do bloco "4" do conjunto
                    Blocos_a_Verificar(0) = 4
                    Blocos_a_Verificar(1) = 999
                    Blocos_a_Verificar(2) = 999
                    Blocos_a_Verificar(3) = 999
        ...
        Case 2
            ...
            Select Case PosicaoDoBloco
                ...
                Case 0
                    ' Verifica as posições diretamente
                    'abaixo dos blocos "2", "3" e "4"
                    Blocos_a_Verificar(0) = 2
                    Blocos_a_Verificar(1) = 3
                    Blocos_a_Verificar(2) = 4
                    Blocos_a_Verificar(3) = 999
    ...
    Do While ContadorTimerJogo <= 3
        ...
        If Blocos_a_Verificar(ContadorTimerJogo) <> 999 Then
            ...
            Posicao_na_Matriz = LocalizarBlocoNaMatriz(IndicesEmJogo(Blocos_a_Verificar(ContadorTimerJogo)))
        
            ' Verifica se a posição logo abaixo deste bloco
            'contém outro bloco ou será a linha 18 da matriz
            
            'Verifica se é a linha 18
...
VerificarNovamente:
        ...
        If Linha_Completa <> 999 Then
            ...
            lblPontos.Caption = CStr(CInt(lblPontos.Caption) + 100)
...
'FIM DE JOGO ===================================
    ...
    Else
        'Move o Bloco uma posição para baixo
        ContadorTimerJogo = 4
        
        Do While ContadorTimerJogo >= 1
        
            If IndicesEmJogo(ContadorTimerJogo) <> 999 Then

                'Move o bloco uma posição abaixo na matriz
                Posicao_na_Matriz = LocalizarBlocoNaMatriz(IndicesEmJogo(ContadorTimerJogo))
                Jogo(Posicao_na_Matriz.PosicaoY + 1, Posicao_na_Matriz.PosicaoX) = Jogo(Posicao_na_Matriz.PosicaoY, Posicao_na_Matriz.PosicaoX)
                Jogo(Posicao_na_Matriz.PosicaoY, Posicao_na_Matriz.PosicaoX) = 999
                
                'Move o bloco 1 posição abaixo em "pctJogo"
                imgBloco(IndicesEmJogo(ContadorTimerJogo)).Top = (imgBloco(IndicesEmJogo(ContadorTimerJogo)).Top + UmaPosicao)
