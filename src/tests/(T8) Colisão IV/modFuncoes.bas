...
Function DetectarColisao(Indice_Bloco As Integer, Direcao_a_Verificar As Integer) As Boolean
'========================================================================
    ...
    Select Case Direcao_a_Verificar
        ...
        Case 39 'Direção para o lado direito
            ...
            'do bloco selecionado
                ...
                If Jogo(Posicao_na_Matriz.PosicaoY, Posicao_na_Matriz.PosicaoX + 1) <> 999 Then
