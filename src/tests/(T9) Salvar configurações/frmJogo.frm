...
VerificarNovamente:
            ...
            'PONTUAÇÃO DO JOGO====================================================
                    ...
                    'adiciona-se "150" à pontuação do jogador. Caso contrário,
                    'adiciona-se "50" à pontuação do jogador.
                    ' Troca-se de nível a cada 6000 pontos e termina-se o jogo
                    'com 1000000 pontos
                    ...
                    If BlocosLinhaIguais = True Then
                        ...
                        'Aumenta-se em 150 a pontuação
                        lblPontos.Caption = CStr(CLng(lblPontos.Caption) + 150)
                    ...
                    Do While ContadorTimerMovimento <= 9
                        ...
                        If CLng(lblPontos.Caption) = (CLng(ContadorTimerMovimento) * 6000) Then
                        'Aumenta um nível
                        ...
                        ElseIf CLng(lblPontos.Caption) >= 1000000 Then 'Salvou o Jogo!
'SALVOU O JOGO=========================================
